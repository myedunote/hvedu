        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <NewsCard
              ...
              href="/news/1"
              imageSrc="/images/news/01.jpg?height=400&width=600"
            />
            <NewsCard
              ...
              href="/news/2"
              imageSrc="/images/news/02.jpg?height=400&width=600"
            />
            <NewsCard
              ...
              href="/news/3"
              imageSrc="/images/news/03.jpg?height=400&width=600"
            />
            <NewsCard
              ...
              href="/news/4"
              imageSrc="/images/news/04.jpg?height=400&width=600"
            />
            <NewsCard
              ...
              href="/news/5"
              imageSrc="/images/news/05.jpg?height=400&width=600"
            />
            <NewsCard
              ...
              href="/news/6"
              imageSrc="/images/news/06.jpg?height=400&width=600"
            />
            <NewsCard
              ...
              href="/news/7"
              imageSrc="/images/news/07.jpg?height=400&width=600"
            />
            <NewsCard
              ...
              href="/news/8"
              imageSrc="/images/news/08.jpg?height=400&width=600"
            />
            <NewsCard
              ...
              href="/news/9"
              imageSrc="/images/news/09.jpg?height=400&width=600"
            />
          </div>
        </div>
      </section>
